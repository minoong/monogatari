...
export const DiscoverActivity: React.FC = () => {
  ...
  return (
    <AppScreen appBar={{ title: "위시" }}>
      <main className="flex-1 h-full bg-slate-50 pb-[calc(3.5rem+max(env(safe-area-inset-bottom,0px),8px))] dark:bg-slate-950">
        ...
        <Button
          aria-label="위시 등록"
          className="fixed bottom-[calc(4.2rem+max(env(safe-area-inset-bottom,0px),8px))] right-5 z-40 h-14 min-w-14 rounded-full px-5 shadow-xl"
