...
export const ExchangeActivity: React.FC = () => {
  ...
  return (
    <AppScreen appBar={{ title: "환율 계산기" }}>
      <div className="flex flex-col flex-1 h-full min-h-full bg-gradient-to-br from-indigo-50/50 via-white to-blue-50/50 dark:from-slate-950 dark:via-gray-950 dark:to-indigo-950/30 text-gray-900 dark:text-white pb-8 overflow-x-hidden">
