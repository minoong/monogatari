  ...
  return (
    <AppScreen appBar={{ title: "여행 준비물 체크리스트" }}>
      <div className="flex flex-col flex-1 h-full bg-white dark:bg-black relative">
        ...
        <div className="flex-1 overflow-y-auto p-4 pb-[calc(3.5rem+clamp(0px,env(safe-area-inset-bottom),34px))]">
          {loading ? (
        ...
        <div
          ...
          style={{ bottom: "calc(4.2rem + clamp(0px, env(safe-area-inset-bottom), 34px))" }}
        >
          <NeumorphButton
            aria-hidden="true"
            type="button"
