  ...
  return (
    <AppScreen appBar={{ title: "여행 준비물 체크리스트" }}>
      <div className="flex flex-col flex-1 h-full bg-white dark:bg-black relative">
        ...
        <div className="flex-1 overflow-y-auto p-4 pb-[calc(3.5rem+max(env(safe-area-inset-bottom,0px),8px))]">
          {loading ? (
        ...
        <div
          ...
          style={{ bottom: "calc(4.2rem + max(env(safe-area-inset-bottom, 0px), 8px))" }}
        >
          <NeumorphButton
            aria-hidden="true"
            type="button"
