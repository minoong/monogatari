...
export function ChecklistDeleteDrawer({
  ...
  return (
    <Drawer open={open} onOpenChange={onOpenChange}>
      <DrawerPopup id="checklist-delete-drawer" variant="inset" showBar>
        <div className="flex min-h-0 w-full flex-1 flex-col" data-theme="light">
          <DrawerHeader className="px-6 pb-2 pt-6 text-left">
            ...
            <DrawerDescription className="text-sm text-gray-600 dark:text-gray-300 pt-2">
              <span className="font-bold text-gray-900 dark:text-white">‘{itemTitle || "선택한 항목"}’</span> 준비물을 정말 삭제하시겠습니까?
            </DrawerDescription>
          </DrawerHeader>
