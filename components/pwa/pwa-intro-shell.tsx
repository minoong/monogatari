import { pwaIntroMediaClassName, pwaIntroOverlayClassName } from "@/components/pwa/pwa-intro-layout";
...
export function PwaIntroShell() {
  return (
    <div
      ...
      className={`${pwaIntroOverlayClassName} grid place-items-center`}
    >
      ...
      <div className="relative z-10 flex flex-col items-center px-6 pt-[env(safe-area-inset-top)] text-center">
