...
export function DrawerFooter({
  ...
  const defaultProps = {
    className: cn(
      ...
      !allowSelection && "cursor-default",
      {
        bare: "in-[[data-slot=drawer-popup]:has([data-slot=drawer-panel])]:pt-3 pt-4 pb-[calc(env(safe-area-inset-bottom,0px)_+_--spacing(6))]",
        default: "border-t bg-muted/72 pt-4 pb-[calc(env(safe-area-inset-bottom,0px)_+_--spacing(4))]",
      }[variant || "default"],
      className,
    ),
